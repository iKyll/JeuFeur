	...
	match scene:
		"SceneFirstWeapon":
			if equipped["FirstWeapon"] == null:
				...
				SceneFirstWeapon._load_texture(item)
			else:
		...
		"SceneSecondWeapon":
			if equipped["SecondWeapon"] == null:
				...
				SceneSecondWeapon._load_texture(item)
			else:
		...
		"SceneHelmet":
			if equipped["Helmet"] == null:
				...
				SceneHelmet._load_texture(item)
			else:
		...
		"SceneChestplate":
			if equipped["Chestplate"] == null:
				...
				SceneChestplate._load_texture(item)
			else:
